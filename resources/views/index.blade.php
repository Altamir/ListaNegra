    ...
    <div class='mdl-grid'>
        ...
        <div class="mdl-card mdl-cell mdl-cell--4-col mdl-cell--3-col-tablet mdl-shadow--3dp ">
            ...
            <div class="mdl-card__actions mdl-card--border">
                ...
                <a class="github-button mdl-button "
                   href="https://github.com/Altamir/listanegra/archive/master.zip"
                   data-style="mega" aria-label="Download Altamir/listanegra on GitHub">Download
                </a>
                @if($user->perfil->name == 'admin')
                    <hr>
                    <a class="mdl-button mdl-js-button mdl-button--raised"
                    href="/adm/reset-banco">
